...
typedef struct {
    ...
    void (*phi2)(double xsi, double eta, double *phi);  // écrit dans phi les valeurs des fonctions de forme pour xsi et eta
    void (*dphi2dx)(double xsi, double eta, double *dphidxsi, double *dphideta);  // écrit dans dphidxsi et dphideta les valeurs des dérivées
} femDiscrete;
