...
double *femElasticitySolve(femProblem *theProblem){
    // J'utilise les deux fonctions d'assemblage
    femElasticityAssembleElements(theProblem);
    femElasticityAssembleNeumann(theProblem);

    // J'ai pompé du code précédent pour les conditions de Dirichlet
    ...
    theProblem->soluce = femFullSystemEliminate(theProblem->system);
